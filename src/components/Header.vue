    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-6" aria-label="Main navigation">
          ...
          <RouterLink
            to="/practice?tab=ai"
            class="inline-flex items-center gap-2 bg-violet-600 text-white px-4 py-2 rounded-lg hover:bg-violet-700 transition active:scale-[0.96] font-medium text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2"
          >
